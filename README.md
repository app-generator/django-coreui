...
Open-source **[Django Dashboard](https://appseed.us/admin-dashboards/django)** generated by AppSeed op top of an iconic design. **[CoreUI](https://appseed.us/admin-dashboards/django-dashboard-coreui)** is an Open Source Bootstrap Admin Template. But **CoreUI** is not just another Admin Template. It goes way beyond hitherto admin templates thanks to transparent code and file structure. And if that's not enough, let’s just add that CoreUI consists bunch of unique features and over 1000 `high-quality` icons.
